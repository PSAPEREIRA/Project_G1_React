...
import UI109CollasibleButton from "./UI109CollasibleButton";
import connect from "react-redux/es/connect/connect";
import {fetchRooms} from "../../../actions/actionsRoom";


class UI109EditRoom extends Component {
...
export default connect(mapStateToProps, mapDispatchToProps)(UI109EditRoom)